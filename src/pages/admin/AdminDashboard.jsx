...
export default function AdminDashboard() {
  ...
  return (
    <Layout>
      <div className="min-h-screen lg:pt-27 pt-50 bg-gradient-to-br from-black via-slate-900 to-gray-800 text-white px-4 py-8">
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <motion.div
            className="bg-gradient-to-br from-black via-slate-900 to-gray-800 border border-violet-700 p-8 rounded-3xl shadow-2xl flex flex-col sm:flex-row items-center gap-8"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
