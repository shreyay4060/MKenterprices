...
export default function UserWorkInfo() {
  ...
  return (
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white pt-20 px-4 pb-16">
        <div className="max-w-3xl mx-auto bg-gray-900  rounded-xl shadow-lg p-6">
          {work ? (
            <>
              ...
              <p className="text-gray-300 mb-2">
                <span className="text-yellow-400 font-medium">Salary:</span> ₹{work.salary}
              </p>
              <p className="text-gray-300 mb-2">
                <span className="text-yellow-400 font-medium">Date:</span> {work.date}
              </p>
